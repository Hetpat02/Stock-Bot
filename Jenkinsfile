        ...
        stage('Clone GitHub Repo') {
            steps {
                script {
                    ...
                    checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'git-token-jenkins', url: 'https://github.com/Hetpat02/Stock-Bot.git']])
                }
            }
        }
